    ...
    return (
        <nav className="fixed top-0 w-full z-30 bg-indigo-50/70 dark:bg-black/70 backdrop-blur-sm border-b
         dark:border-white/10 border-indigo-600/20">
            <div className="flex items-center justify-between px-6 py-1 dark:text-white">
                ...
                <div className='p-2'>
                    <button onClick={toggle}>
                        <span className="material-symbols-rounded dark:text-white dark:hover:bg-white/10 rounded-full hover:bg-indigo-100 transition-colors duration-300 p-2 cursor-pointer">
                ...
                <div className="flex items-center gap-8">
                    ...
                    {/**Logout */}
                    <button onClick={handleLogout} className="flex items-center gap-2 px-3 py-2 hover:shadow-md rounded-md hover:bg-indigo-200/30 dark:hover:bg-white/10 transition-colors duration-300 cursor-pointer">
