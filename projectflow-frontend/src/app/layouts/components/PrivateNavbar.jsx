            ...
            <div className="flex items-center justify-between px-6 py-3 dark:text-white">
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-3 rounded-md">
                        ...
                        <div className="w-9 h-9 rounded-full bg-indigo-200/40 hover:bg-indigo-500/30 dark:bg-[#A3FF12]/15 border border-indigo-500 dark:border-[#A3FF12]/30 flex items-center justify-center transition-colors duration-300 dark:hover:bg-[#A3FF12]/25">
