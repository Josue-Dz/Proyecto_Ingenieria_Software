...
const TaskDetailModal = ({ task, proyectoId, onClose, onTaskUpdated }) => {
                    ...
                    <div className="flex-1 px-6 py-5 flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                className="bg-slate-50 dark:bg-white/4 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2.5 text-slate-600 dark:text-white/70 text-sm focus:outline-none focus:border-indigo-400
