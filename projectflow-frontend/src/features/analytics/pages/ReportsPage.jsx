...
const ReportePage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0b0b0c] px-6 py-8">
            ...
            <div className="flex items-center gap-3 mb-8">
                ...
                >
                    <span className="material-symbols-rounded text-slate-600 dark:text-white/60 text-[20px]">
                        arrow_back
                    </span>
                </button>
                <div>
            ...
            <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 rounded-2xl p-6 mb-6">
                ...
                <div className="flex flex-wrap gap-4 items-end">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            className="bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-lg px-3 py-2 text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/30 dark:focus:ring-[#A3FF12]/20 focus:border-indigo-400 dark:focus:border-[#A3FF12]/40 transition"
                        />
                    </div>
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 dark:bg-[#A3FF12]/15 dark:text-[#A3FF12] dark:border dark:border-[#A3FF12]/30 text-white text-sm font-semibold transition disabled:opacity-50"
                    >
                        {loading
            ...
            {error && (
                <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 text-sm mb-6">
            ...
            {data && !loading && (
                <>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 rounded-2xl p-5">
                            <p className="text-xs text-slate-500 dark:text-white/40 mb-1">
                                Completitud del sprint
                            </p>
                            <p className="text-3xl font-semibold text-indigo-600 dark:text-[#A3FF12]">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-600 dark:text-white/70 text-sm hover:bg-slate-50 dark:hover:bg-white/5 transition disabled:opacity-50"
                            >
                                {exportLoading === "pdf"
                                    ? <span className="material-symbols-rounded text-sm animate-spin">progress_activity</span>
            ...
            {!data && !loading && !error && (
                <div className="flex flex-col items-center justify-center py-24 gap-3">
                    <span className="material-symbols-rounded text-slate-300 dark:text-white/20 text-5xl">
                        insights
                    </span>
