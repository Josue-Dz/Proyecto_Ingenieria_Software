    ...
    return (
        <div className="relative" ref={bellRef}>
            ...
            {open && (
                <div
                    ref={panelRef}
                    className="absolute right-0 top-11 w-80 bg-white dark:bg-[#1a1a1a]
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-4 py-3 border-b
                     border-slate-100 dark:border-white/8">
                        <h3 className="text-slate-800 dark:text-white font-semibold text-sm">
                            ...
                            {noLeidas > 0 && (
                                <span className="ml-2 px-1.5 py-0.5 rounded-full
                                 bg-red-500/15 text-red-500 text-[10px] font-bold">
                                    {noLeidas}
                                </span>
                            )}
                        </h3>
                        ...
                        <div className="flex items-center gap-2">
                            {/* Toggle no leídas / todas */}
                            <button
                                onClick={() => setSoloNoLeidas(!soloNoLeidas)}
                                className={`text-xs px-2 py-0.5 rounded-full border
                                 transition-colors ${soloNoLeidas
                                    ? "bg-indigo-50 dark:bg-[#A3FF12]/10 text-indigo-500 dark:text-[#A3FF12] border-indigo-200 dark:border-[#A3FF12]/20"
                                    : "text-slate-400 dark:text-white/30 border-slate-200 dark:border-white/10 hover:border-slate-300"
                                }`}
                            >
                    ...
                    <div className="max-h-96 overflow-y-auto">
                             ...
                             py-10 gap-2">
                                ...
                                {soloNoLeidas && notificaciones.length > 0 && (
                                    <button
                                        ...
                                        className="text-indigo-500 dark:text-[#A3FF12]
                        ...
                        {!loading && notificacionesFiltradas.map((notif) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-start gap-3 px-4 py-3
                                     ...
                                     dark:hover:bg-white/5 ${!notif.leida
                                        ? "bg-indigo-50/50 dark:bg-white/3"
                                        : ""
                                    }`}
                                >
                                    <div className={`w-8 h-8 rounded-full flex items-center
                                     justify-center shrink-0 ${!notif.leida
